...
import static org.openlmis.requisition.batch.i18n.MessageKeys.ERROR_INVALID_BOOLEAN_FORMAT;
import static org.openlmis.requisition.batch.i18n.MessageKeys.ERROR_INVALID_DATE_FORMAT;
import static org.openlmis.requisition.batch.i18n.MessageKeys.ERROR_INVALID_UUID_FORMAT;
...
public final class SearchParams {
  ...
  public LocalDate getLocalDate(String key) {
    ...
    try {
      ...
      throw new ValidationMessageException(
          new Message(ERROR_INVALID_DATE_FORMAT, value, key),
          cause);
    }
  }
  ...
  /**
   * Parses String value into {@link Integer}.
   * If format is wrong null value will be returned.
   *
   * @param key key for value be parsed into Integer
  ...
  public Integer getInteger(String key) {
    ...
    try {
      ...
      throw new ValidationMessageException(
          new Message(ERROR_INVALID_BOOLEAN_FORMAT, value, key),
          ex);
    }
    return integerValue;
  }

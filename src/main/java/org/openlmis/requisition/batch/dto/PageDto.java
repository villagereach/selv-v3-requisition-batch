...
import org.openlmis.requisition.batch.util.CustomSortDeserializer;
...
public final class PageDto<T> implements Page<T> {
  ...
  public PageDto(Page<T> page) {
    this(
        notNull(page).isLast(), page.isFirst(), page.getTotalPages(),
        page.getTotalElements(), page.getSize(), page.getNumber(),
        page.getNumberOfElements(), page.getSort(), notNull(page.getContent())
    );
  }

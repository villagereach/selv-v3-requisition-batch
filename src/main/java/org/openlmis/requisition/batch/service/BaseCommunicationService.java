...
package org.openlmis.requisition.batch.service;

import static org.openlmis.requisition.batch.i18n.MessageKeys.ERROR_SERVICE_OCCURRED;
import static org.openlmis.requisition.batch.i18n.MessageKeys.ERROR_SERVICE_REQUIRED;
import static org.openlmis.requisition.batch.util.RequestHelper.createEntity;
import static org.openlmis.requisition.batch.util.RequestHelper.createUri;
...
import org.openlmis.requisition.batch.dto.PageDto;
import org.openlmis.requisition.batch.exception.DataRetrievalException;
import org.openlmis.requisition.batch.service.auth.AuthService;
import org.openlmis.requisition.batch.service.dto.DynamicPageTypeReference;
import org.openlmis.requisition.batch.service.dto.DynamicResultDtoTypeReference;
import org.openlmis.requisition.batch.service.dto.ResultDto;
import org.openlmis.requisition.batch.service.dto.ServiceResponse;
import org.openlmis.requisition.batch.util.Merger;
import org.openlmis.requisition.batch.util.Message;
import org.openlmis.requisition.batch.util.RequestHeaders;
import org.openlmis.requisition.batch.util.RequestHelper;
import org.openlmis.requisition.batch.util.RequestParameters;
...
public abstract class BaseCommunicationService<T> {
  ...
  private <E> ResponseEntity<E[]> doListRequest(String url, RequestParameters parameters,
                                                ...
                                                Class<E[]> type) {
    HttpEntity<Object> entity = createEntity(payload, authService.obtainAccessToken());

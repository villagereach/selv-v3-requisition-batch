...
public class UserDtoTest extends ToStringContractTest<UserDto> {

  @Override
  protected Class<UserDto> getTestClass() {
    return UserDto.class;
  }

  @Override
  protected void prepare(EqualsVerifier<UserDto> verifier) {

...
public class DetailedRoleAssignmentDtoTest extends ToStringContractTest<DetailedRoleAssignmentDto> {

  @Override
  protected Class<DetailedRoleAssignmentDto> getTestClass() {
